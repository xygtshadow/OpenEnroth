...
extern IndexedArray<std::array<unsigned char, 2>, SPEECH_FIRST, SPEECH_LAST> speechVariantsMm6;
extern IndexedArray<std::array<PortraitId, 5>, SPEECH_FIRST, SPEECH_LAST> portraitVariantsMm6;
extern std::array<std::array<unsigned char, 12>, 44> mm6SpeechSubvariantCounts;
