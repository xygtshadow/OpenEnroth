 ...
 public:
    ...
    class Graphics : public ConfigSection {
     public:
        ...
        Int RenderFilter = {this, "render_filter", 0, &ValidateRenderFilter,
                            ...
                            " render_width/render_height are ignored, the UI space is fixed at 640x480),"
    ...
    class Settings : public ConfigSection {
     public:
        ...
        Float MouseLookSensitivity = { this, "mouse_look_sens", 1.0f, "Mouse sensitivity in mouse look mode." };
