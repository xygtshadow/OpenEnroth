...
static constexpr IndexedArray<InputActionTriggerMode, INPUT_ACTION_FIRST_VALID, INPUT_ACTION_LAST_VALID> triggerModeByInputAction = {
    ...
    {INPUT_ACTION_ARCOMAGE_PLAY_CARD,   TRIGGER_ONCE},
    {INPUT_ACTION_ARCOMAGE_DISCARD,     TRIGGER_ONCE},
    {INPUT_ACTION_ARCOMAGE_LEFT,        TRIGGER_ONCE},
    {INPUT_ACTION_ARCOMAGE_RIGHT,       TRIGGER_ONCE},
};
